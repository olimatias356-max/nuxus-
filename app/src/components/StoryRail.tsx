    ...
    <FlatList
      ...
      ListHeaderComponent={
        me ? (
          <Pressable
            ...
            <View>
              <Avatar path={me.avatar_path} name={me.username} size={68} ring={mine ? (mine.has_unseen ? 'unseen' : 'seen') : 'none'} />
              {!mine ? (
      ...
      renderItem={({ item }) => (
        <Pressable
          ...
          <Avatar path={item.avatar_path} name={item.username} size={68} ring={item.has_unseen ? 'unseen' : 'seen'} />
